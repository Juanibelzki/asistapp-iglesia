...
function About() {
  return (
    <div className="demo-page">
      <h1 className="text-3xl font-bold mb-6">Sobre AsistApp</h1>
      <p className="text-lg text-[var(--sea-ink-soft)] mb-6">
        AsistApp nace para facilitar la administración y seguridad en el registro de asistencia infantil en actividades eclesiásticas.
      </p>

  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col font-sans">
      <main className="flex-1 w-full max-w-md mx-auto p-4 md:p-6 space-y-6 pb-10">
        {/* CREDENCIAL DIGITAL */}
        <section className="bg-zinc-900/60 border border-zinc-800 rounded-2xl p-6 shadow-2xl shadow-black/40">
          ...
          <div className="mt-5 bg-white rounded-2xl p-5 flex flex-col items-center">
            <QRCodeSVG
                ...
                >
                  ...
                  {mat.file_url && (
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold text-xs transition shadow-lg shadow-emerald-500/20"
                    >
